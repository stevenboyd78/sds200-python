...
def test_roadmap_names_milestone_25_6_as_active_web_dashboard_boundary() -> None:
    ...
    assert "Milestone 25.5 is closed" in active_milestone
    ...
    assert "Milestone 25.7" in active_milestone
